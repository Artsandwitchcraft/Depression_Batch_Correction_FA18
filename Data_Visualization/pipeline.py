...
#    y = [data[1] for data in kBet_data]
    ...
    Correction    = ['Z_score','Combat','Limma', "PCA Loading", "No Correction", "Toups Unfiltered", "Toups Filtered", "Combined Unfiltered", "Combined Filtered"]
...
#print(kBet_data)
    ...
    for data in kBet_data:
        ...
        # we need for dataset
        ax1.scatter(x, y, c = correctionMethod, marker = filterMethod, s = 100)
...
#    list_lab = ['Z_Score', 'ComBat', 'Limma', 'PCA_Loading', 'No Correction', 'Toups Unfiltered', 'Toups Filtered', 'Combined Unfiltered', 'Combined Filtered']
    ...
    list_color  = ["b", "g", "r", "c", "m", "k", "k", "k", "k"]
    list_mak    = ["o","o","o", "o", "o", "*", "d", "s", "P"]
    list_lab    = ['Z_score','Combat','Limma', "PCA Loading", "No Correction", "Toups Unfiltered", "Toups Filtered", "Combined Unfiltered", "Combined Filtered"]
